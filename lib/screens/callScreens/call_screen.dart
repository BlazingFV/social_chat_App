...
class CallScreen extends StatefulWidget {
  final Call call;
  bool videoCall;
  CallScreen({this.call, this.videoCall});
  @override
...
class _CallScreenState extends State<CallScreen> {
  ...
  addPostFramCallback() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      streamSubscription = callCollection
          .document(Photos.myID)
          .snapshots()
  ...
  Future<void> _initAgoraRtcEngine() async {
    await AgoraRtcEngine.create(API_Key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          children: <Widget>[
            widget.videoCall ? _viewRows() : _panel(),
            _toolbar(),
          ],
        ),
      ),
